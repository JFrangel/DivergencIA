...
const DEFAULT_CONFIG = {
  nombre_plataforma:   'DivergencIA',
  registro_publico:    true,
  requiere_aprobacion: false,
  athenia_activo:      true,
  zen_mode_activo:     false,
  roadmap_publico:     false,
  max_upload_mb:       50,
  email_contacto:      'admin@divergencia.com',
}
...
export default function PlatformConfig() {
  ...
  const handleSave = async () => {
    ...
    if (err) {
      ...
      try {
        localStorage.setItem('divergencia_platform_config', JSON.stringify({
